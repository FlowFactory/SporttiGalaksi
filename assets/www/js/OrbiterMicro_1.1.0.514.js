...
net.user1.orbiter.Orbiter.prototype.buildConnection = function (host, port, type, sendDelay) {
  ...
  console.log('host:' + host + ', port:' + port + ', type:' + type + ', sendDelay:' + sendDelay );
  ...
  switch (type) {
    ...
    case net.user1.orbiter.ConnectionType.WEBSOCKET:
	  ...
	  console.log('WEBSOCKET CONNECTION, LINE 2260');
      break;
  ...
  try {
    ...
    console.log("[CONNECTION] " + connection.toString() + " " + e);
  } finally {
...
net.user1.orbiter.WebSocketConnection.prototype.getNewSocket = function () {
  ...
  console.log('LINE 2960 WEBSOCKET LUONTI');
